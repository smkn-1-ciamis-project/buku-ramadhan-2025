/**
 * Buku Ramadhan — Formulir Harian Buddha Alpine.js Component
...
function formulirBuddha() {
    return {
        ...
        loadFormConfig() {
            var self = this;
            fetch("/api/form-settings/Buddha", {
        ...
        validateForm() {
            var errors = [];
            // Minimal 1 pengendalian diri wajib diisi
                    ...
                    if (data.success && data.submitted_days) {
                        ...
                        if (data.submissions) {
                            data.submissions.forEach(function (sub) {
                                ...
                                var key = "buddha_form_day_" + sub.hari_ke;
