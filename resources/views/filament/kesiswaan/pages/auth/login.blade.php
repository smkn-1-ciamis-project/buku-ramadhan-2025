<div class="login-page" x-data="{ showErrorPopup: $wire.entangle('showErrorPopup') }">
  ...
  @once
    @push('styles')
      ...
      <style>
        ...
        /* ── Kesiswaan color overrides ── */
        .ks-login .login-illust-col {
          background: linear-gradient(160deg, #0f172a 0%, #1e3a5f 35%, #2563eb 100%) !important;
        }
      </style>
    @endpush
  @endonce
  ...
  {{-- ═══════════════════════════════
      MAIN 2-COLUMN CARD
  ═══════════════════════════════ --}}
  <div class="login-container ks-login">

    {{-- ── LEFT: Form Column ── --}}
    <div class="login-form-col">

      {{-- Form Title --}}
      <div class="login-form-title">Login Kesiswaan</div>
      <div class="login-form-subtitle">Masuk ke Panel Kesiswaan Calakan</div>
      ...
      <div style="margin-top: 1rem; display: flex; flex-direction: column; gap: 0.5rem; align-items: center;">
        <div style="display: flex; align-items: center; gap: 1rem; width: 100%;">
          ...
          <span style="font-size: 12px; color: #94a3b8; white-space: nowrap;">Bukan kesiswaan?</span>
          <div style="flex: 1; height: 1px; background: #e2e8f0;"></div>
        </div>
    ...
    <div class="login-illust-col">
      ...
      <div class="illust-main">
        ...
        <div class="illust-subtitle">Portal Kesiswaan<br>SMKN 1 Ciamis</div>
