<div class="login-page" x-data="{ showErrorPopup: $wire.entangle('showErrorPopup') }">
  ...
  <div class="login-container guru-login">
    ...
    <div class="login-form-col">
      ...
      {{-- Form Title --}}
      <div class="login-form-title">Login Guru</div>
      <div class="login-form-subtitle">Masuk ke Panel Guru Calakan</div>
    ...
    <div class="login-illust-col">
      ...
      <div class="illust-main">
        ...
        <div class="illust-subtitle">Portal Guru<br>SMKN 1 Ciamis</div>
        ...
        {{-- Buku panduan role guru --}}
        <div style="margin-top: 0.8rem; display: flex; justify-content: center;">
          <a href="{{ route('buku-panduan', ['role' => 'guru']) }}" target="_blank" rel="noopener noreferrer"
