...
<body>
  ...
  {{-- ═══ JUDUL ═══ --}}
  <div class="doc-title">Data Siswa</div>
  ...
  <div class="info-bar">
    <table>
      <tr>
        ...
        <td>: {{ $kelas }}</td>
        <td class="label" style="text-align: right; width: 130px;">Tahun Ajaran</td>
        <td style="width: 120px;">: {{ $tahunAjaran }}</td>
      </tr>
      <tr>
  ...
  <table class="data">
    <thead>
      <tr>
        ...
        <th>Nama Lengkap</th>
        <th class="text-center" style="width: 85px;">NISN</th>
        <th class="text-center" style="width: 35px;">JK</th>
        <th class="text-center" style="width: 70px;">Agama</th>
    ...
    <tbody>
      ...
      @empty
        <tr>
          <td colspan="6" class="text-center" style="padding: 20px; color: #999;">Belum ada data siswa</td>
        </tr>
      @endforelse
    </tbody>
  </table>
    ...
    <table>
      <tr>
        ...
        <td class="sign-block">
          ...
          <div style="margin-top: 4px;">Wali Kelas {{ $kelas }}</div>
          <div class="sign-line"></div>
          <div class="sign-name">{{ $guru }}</div>
        </td>
      </tr>
    </table>
  </div>
