<x-filament-panels::page>
    <script>window.__siswaUserId = '{{ auth()->id() }}'; window.__userAgama = '{{ auth()->user()->agama ?? "Konghucu" }}'; window.__appSettings = @json(\App\Models\AppSetting::getForFrontend());</script>
    ...
    @push('scripts')
        <script src="{{ asset('themes/ramadhan/js/nonmuslim/konghucu/formulir.js') }}?v={{ filemtime(public_path('themes/ramadhan/js/nonmuslim/konghucu/formulir.js')) }}" defer></script>
    @endpush
</x-filament-panels::page>
