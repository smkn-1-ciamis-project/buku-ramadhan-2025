    ...
    <div x-data="konghucuDashboard()" x-init="init()" class="ramadhan-app" data-formulir-url="{{ \App\Filament\Siswa\Pages\NonMuslim\Konghucu\FormulirHarian::getUrl() }}">
        ...
        <div class="hero-header">
            ...
            <div class="absolute inset-0 overflow-hidden pointer-events-none" style="border-radius: 0 0 2rem 2rem;">
                ...
                {{-- â˜… Klenteng (Chinese temple) silhouette bottom-left --}}
                ...
                {{-- â˜… Pagoda silhouette bottom-right --}}
                ...
                {{-- â˜… Bagua (å…«å¦) octagonal pattern top-left --}}
                ...
                {{-- â˜… Phoenix / Crane bird floating left --}}
                ...
                {{-- â˜… Incense burner (Hio/Dupa) floating left-mid --}}
                ...
                {{-- â˜… Small Yin-Yang accent mid-right --}}
                ...
                {{-- â˜… Scroll / Book of wisdom floating right-center --}}
                <div style="position:absolute; top:35%; right:6%; animation: float-slow 6s ease-in-out infinite;">
                    <svg width="44" height="36" viewBox="0 0 56 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {{-- Chinese character hint (ä» - Ren / Benevolence) --}}
            ...
            <div class="ramadhan-content">
                ...
                <div class="center-menu-wrap">
                    <div class="center-menu">
                        ...
                        <a href="{{ \App\Filament\Siswa\Pages\NonMuslim\Konghucu\FormulirHarian::getUrl() }}" class="center-menu-btn" style="text-decoration:none;">
                            <div class="center-menu-icon">
...
@push('scripts')
    <script src="{{ asset('themes/ramadhan/js/nonmuslim/konghucu/dashboard.js') }}?v={{ filemtime(public_path('themes/ramadhan/js/nonmuslim/konghucu/dashboard.js')) }}" defer></script>
@endpush
