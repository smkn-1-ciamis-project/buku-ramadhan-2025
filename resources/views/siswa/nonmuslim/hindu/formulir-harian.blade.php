<x-filament-panels::page>
    <script>window.__siswaUserId = '{{ auth()->id() }}'; window.__userAgama = '{{ auth()->user()->agama ?? "Hindu" }}'; window.__appSettings = @json(\App\Models\AppSetting::getForFrontend());</script>
    <div x-data="formulirHindu()" x-init="init()" class="formulir-page">
        ...
        <div class="formulir-topbar">
            <a href="{{ \App\Filament\Siswa\Pages\NonMuslim\Hindu\Dashboard::getUrl() }}" class="formulir-back-btn">
        ...
        <template x-if="formDisabled">
            <div class="formulir-disabled-overlay">
                <div class="formulir-disabled-card">
                    ...
                    <a href="{{ \App\Filament\Siswa\Pages\NonMuslim\Hindu\Dashboard::getUrl() }}" class="formulir-disabled-btn">Kembali ke Dashboard</a>
                </div>
            </div>
        </template>
            ...
            <div class="formulir-content">
                ...
                <div x-show="showWorshipReminder" x-cloak class="f-church-reminder">
                    ...
                    <div class="f-church-body">
                        ...
                        <p class="f-church-sub">Jangan lupa untuk melakukan puja dan sembahyang di pura atau di rumah!</p>
                    </div>
                </div>
