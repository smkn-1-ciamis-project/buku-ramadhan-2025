<x-filament-panels::page>
    ...
    <div x-data="hinduDashboard()" x-init="init()" class="ramadhan-app" data-formulir-url="{{ \App\Filament\Siswa\Pages\NonMuslim\Hindu\FormulirHarian::getUrl() }}">
            ...
            <div class="absolute inset-0 overflow-hidden pointer-events-none" style="border-radius: 0 0 2rem 2rem;">
                ...
                <div class="islamic-deco islamic-deco-moon" style="top:6%; right:4%;">
                    <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {{-- Om symbol (à¥) stylized --}}
                        <text x="32" y="42" text-anchor="middle" fill="white" opacity="0.18" font-size="36" font-family="serif" font-weight="bold">à¥</text>
                        {{-- Light rays --}}
                        <line x1="32" y1="2" x2="32" y2="8" stroke="white" stroke-width="1" opacity="0.12"/>
                        <line x1="6" y1="32" x2="12" y2="32" stroke="white" stroke-width="1" opacity="0.1"/>
                        <line x1="52" y1="32" x2="58" y2="32" stroke="white" stroke-width="1" opacity="0.1"/>
                        <line x1="14" y1="14" x2="18" y2="18" stroke="white" stroke-width="0.8" opacity="0.08"/>
                        <line x1="50" y1="14" x2="46" y2="18" stroke="white" stroke-width="0.8" opacity="0.08"/>
                    </svg>
                </div>
                ...
                {{-- â˜… Pura (Balinese temple) silhouette bottom-left --}}
                <div class="islamic-deco islamic-deco-mosque" style="bottom:0; left:0;">
                    <svg width="200" height="120" viewBox="0 0 260 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                        {{-- Main Pura tower (Meru) - tallest --}}
                        <path d="M60 140 L60 45 L48 45 L66 10 L84 45 L72 45 L72 140Z" fill="white" opacity="0.07"/>
                        {{-- Tiered roof layers (Meru tumpang) --}}
                        <path d="M45 55 L66 30 L87 55Z" fill="white" opacity="0.09"/>
                        <path d="M48 70 L66 48 L84 70Z" fill="white" opacity="0.08"/>
                        <path d="M50 85 L66 65 L82 85Z" fill="white" opacity="0.07"/>
                        <path d="M52 100 L66 82 L80 100Z" fill="white" opacity="0.06"/>
                        {{-- Finial on top --}}
                        <rect x="63" y="5" width="6" height="10" rx="3" fill="white" opacity="0.12"/>
                        <circle cx="66" cy="4" r="3" fill="white" opacity="0.1"/>
                        {{-- Base platform (Batur) --}}
                        <rect x="15" y="120" width="140" height="30" fill="white" opacity="0.05"/>
                        <rect x="25" y="110" width="120" height="15" fill="white" opacity="0.06"/>
                        {{-- Side smaller Meru --}}
                        <path d="M120 140 L120 75 L112 75 L128 50 L144 75 L136 75 L136 140Z" fill="white" opacity="0.05"/>
                        <path d="M110 82 L128 62 L146 82Z" fill="white" opacity="0.06"/>
                        <path d="M112 95 L128 78 L144 95Z" fill="white" opacity="0.05"/>
                        {{-- Gate (Candi Bentar) --}}
                        <rect x="30" y="95" width="14" height="45" fill="white" opacity="0.06"/>
                        <rect x="15" y="95" width="14" height="45" fill="white" opacity="0.06"/>
                        <path d="M12 95 L30 75 L48 95Z" fill="white" opacity="0.07"/>
                        {{-- Stepping stones --}}
                        <rect x="175" y="140" width="30" height="10" rx="2" fill="white" opacity="0.03"/>
                        <rect x="195" y="135" width="25" height="15" rx="2" fill="white" opacity="0.03"/>
                    </svg>
                </div>

                {{-- â˜… Small Hindu temple silhouette bottom-right --}}
                <div class="islamic-deco islamic-deco-mosque2" style="bottom:0; right:0;">
                    <svg width="180" height="110" viewBox="0 0 220 130" fill="none" xmlns="http://www.w3.org/2000/svg">
                        {{-- Temple body --}}
                        <rect x="60" y="60" width="100" height="70" fill="white" opacity="0.06"/>
                        {{-- Shikhara (tower/spire) --}}
                        <path d="M85 60 L110 10 L135 60Z" fill="white" opacity="0.07"/>
                        <path d="M90 55 L110 18 L130 55Z" fill="white" opacity="0.06"/>
                        {{-- Kalasha (finial) on top --}}
                        <rect x="107" y="2" width="6" height="12" rx="3" fill="white" opacity="0.1"/>
                        <circle cx="110" cy="1" r="3" fill="white" opacity="0.08"/>
                        {{-- Mandapa (pillared hall) --}}
                        <rect x="68" y="80" width="6" height="50" fill="white" opacity="0.06"/>
                        <rect x="88" y="80" width="6" height="50" fill="white" opacity="0.06"/>
                        <rect x="126" y="80" width="6" height="50" fill="white" opacity="0.06"/>
                        <rect x="146" y="80" width="6" height="50" fill="white" opacity="0.06"/>
                        {{-- Arched entrance --}}
                        <path d="M98 130 L98 95 Q110 82 122 95 L122 130Z" fill="white" opacity="0.08"/>
                        {{-- Decorative arch motif --}}
                        <path d="M80 60 Q110 45 140 60" stroke="white" stroke-width="1" fill="none" opacity="0.06"/>
                        {{-- Om symbol on temple --}}
                        <text x="110" y="78" text-anchor="middle" fill="white" opacity="0.08" font-size="14" font-family="serif">à¥</text>
                        {{-- Tropical trees --}}
                        <path d="M25 95 L32 65 L39 95Z" fill="white" opacity="0.05"/>
                        <path d="M28 105 L32 78 L36 105Z" fill="white" opacity="0.04"/>
                        <rect x="30" y="95" width="4" height="35" fill="white" opacity="0.04"/>
                        <path d="M190 90 L198 62 L206 90Z" fill="white" opacity="0.05"/>
                        <rect x="196" y="90" width="4" height="40" fill="white" opacity="0.04"/>
                    </svg>
                </div>

                {{-- â˜… Mandala / geometric pattern top-left --}}
                <div class="islamic-deco islamic-deco-geo" style="top:-20px; left:-20px;">
                    <svg width="120" height="120" viewBox="0 0 100 100" fill="none" opacity="0.06">
                        ...
                        <circle cx="50" cy="50" r="24" stroke="white" stroke-width="0.6" fill="none"/>
                        {{-- Inner lotus/mandala pattern --}}
                        <path d="M50 18 Q58 34 50 50 Q42 34 50 18Z" fill="white"/>
                        <path d="M50 82 Q42 66 50 50 Q58 66 50 82Z" fill="white"/>
                        <path d="M18 50 Q34 42 50 50 Q34 58 18 50Z" fill="white"/>
                        <path d="M82 50 Q66 58 50 50 Q66 42 82 50Z" fill="white"/>
                        {{-- Diagonal petals --}}
                        <path d="M27 27 Q42 38 50 50 Q38 42 27 27Z" fill="white" opacity="0.8"/>
                        <path d="M73 27 Q58 42 50 50 Q62 38 73 27Z" fill="white" opacity="0.8"/>
                        <path d="M27 73 Q38 58 50 50 Q42 62 27 73Z" fill="white" opacity="0.8"/>
                        <path d="M73 73 Q62 58 50 50 Q58 62 73 73Z" fill="white" opacity="0.8"/>
                        {{-- Center dot --}}
                        <circle cx="50" cy="50" r="4" fill="white" opacity="0.9"/>
                    </svg>
                </div>

                {{-- â˜… Lotus flower floating left (instead of dove) --}}
                <div class="islamic-deco islamic-deco-lantern" style="top:8%; left:20%;">
                    <svg width="48" height="40" viewBox="0 0 60 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                        {{-- Center petal --}}
                        <path d="M30 8 Q34 20 30 32 Q26 20 30 8Z" fill="white" opacity="0.12"/>
                        {{-- Left petals --}}
                        <path d="M18 18 Q26 22 30 32 Q22 26 18 18Z" fill="white" opacity="0.1"/>
                        <path d="M10 28 Q20 28 30 32 Q18 32 10 28Z" fill="white" opacity="0.08"/>
                        {{-- Right petals --}}
                        <path d="M42 18 Q34 22 30 32 Q38 26 42 18Z" fill="white" opacity="0.1"/>
                        <path d="M50 28 Q40 28 30 32 Q42 32 50 28Z" fill="white" opacity="0.08"/>
                        {{-- Base --}}
                        <path d="M20 34 Q30 38 40 34 Q36 40 30 42 Q24 40 20 34Z" fill="white" opacity="0.06"/>
                        {{-- Center --}}
                        <circle cx="30" cy="28" r="3" fill="white" opacity="0.15"/>
                        {{-- Dots (pollen) --}}
                        <circle cx="30" cy="14" r="1" fill="white" opacity="0.12"/>
                        <circle cx="24" cy="22" r="0.8" fill="white" opacity="0.1"/>
                        <circle cx="36" cy="22" r="0.8" fill="white" opacity="0.1"/>
                    </svg>
                </div>

                {{-- â˜… Diya / oil lamp (instead of bible) floating right-center --}}
                <div style="position:absolute; top:35%; right:6%; animation: float-slow 6s ease-in-out infinite;">
                    <svg width="44" height="36" viewBox="0 0 56 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                        {{-- Flame --}}
                        <path d="M28 4 Q24 12 25 16 Q28 12 28 8 Q28 12 31 16 Q32 12 28 4Z" fill="white" opacity="0.15"/>
                        <path d="M28 8 Q26 12 26.5 14 Q28 11 29.5 14 Q30 12 28 8Z" fill="white" opacity="0.1"/>
                        {{-- Glow --}}
                        <circle cx="28" cy="12" r="6" fill="white" opacity="0.04"/>
                        {{-- Lamp bowl --}}
                        <path d="M18 20 Q16 28 20 32 L36 32 Q40 28 38 20Z" fill="white" opacity="0.08" stroke="white" stroke-width="0.8" opacity="0.12"/>
                        {{-- Wick --}}
                        <rect x="27" y="16" width="2" height="5" fill="white" opacity="0.1"/>
                        {{-- Spout --}}
                        <path d="M38 24 L44 22 L42 26Z" fill="white" opacity="0.1"/>
                        {{-- Base / stand --}}
                        <rect x="20" y="32" width="16" height="3" rx="1" fill="white" opacity="0.1"/>
                        <rect x="22" y="35" width="12" height="4" rx="2" fill="white" opacity="0.08"/>
                        <rect x="18" y="39" width="20" height="3" rx="1" fill="white" opacity="0.1"/>
                    </svg>
                </div>
            </div>

            {{-- â˜… Trishula (trident) floating (instead of music notes) --}}
            <div style="position:absolute; top:25%; left:35%; animation: float-slow 7s ease-in-out infinite; animation-delay: 2s; z-index:0;">
                <svg width="28" height="36" viewBox="0 0 32 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                    {{-- Shaft --}}
                    <rect x="14" y="12" width="4" height="28" rx="1" fill="white" opacity="0.1"/>
                    {{-- Center prong --}}
                    <path d="M16 0 L14 12 L18 12Z" fill="white" opacity="0.12"/>
                    {{-- Left prong --}}
                    <path d="M6 6 Q10 10 14 14" stroke="white" stroke-width="1.5" fill="none" opacity="0.1"/>
                    <circle cx="5" cy="5" r="2" fill="white" opacity="0.1"/>
                    {{-- Right prong --}}
                    <path d="M26 6 Q22 10 18 14" stroke="white" stroke-width="1.5" fill="none" opacity="0.1"/>
                    <circle cx="27" cy="5" r="2" fill="white" opacity="0.1"/>
                    {{-- Connector --}}
                    <path d="M10 14 L22 14" stroke="white" stroke-width="1" opacity="0.08"/>
                </svg>
            </div>

            {{-- â˜… Small Om accent mid-right --}}
            <div style="position:absolute; top:45%; right:16%; animation: float-slow 5.5s ease-in-out infinite; animation-delay: 0.8s; z-index:0;">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    <text x="12" y="18" text-anchor="middle" fill="white" opacity="0.12" font-size="20" font-family="serif">à¥</text>
                </svg>
            </div>

            {{-- â˜… Lotus small (peace / purity) --}}
            <div style="position:absolute; top:50%; left:28%; animation: float-slow 6.5s ease-in-out infinite; animation-delay: 3s; z-index:0;">
                <svg width="16" height="15" viewBox="0 0 24 22" fill="white" opacity="0.08">
                    <path d="M12 2 Q14 8 12 14 Q10 8 12 2Z"/>
                    <path d="M6 6 Q10 10 12 14 Q8 10 6 6Z"/>
                    <path d="M18 6 Q14 10 12 14 Q16 10 18 6Z"/>
                    <path d="M3 12 Q8 12 12 14 Q7 14 3 12Z"/>
                    <path d="M21 12 Q16 12 12 14 Q17 14 21 12Z"/>
                </svg>
            </div>
            ...
            <div class="ramadhan-content">
                ...
                <div class="center-menu-wrap">
                    <div class="center-menu">
                        ...
                        <a href="{{ \App\Filament\Siswa\Pages\NonMuslim\Hindu\FormulirHarian::getUrl() }}" class="center-menu-btn" style="text-decoration:none;">
                            <div class="center-menu-icon">
                ...
                <div class="content-area">
                        ...
                        <div class="card">
                            ...
                            <template x-if="calendarDays.filter(d => d.isPastUnfilled).length > 0">
                                <div class="cal-alert">
                                    ...
                                    <a href="{{ \App\Filament\Siswa\Pages\NonMuslim\Hindu\FormulirHarian::getUrl() }}" class="cal-alert-btn" style="text-decoration:none;">
                                        Isi Sekarang
                                    </a>
                                </div>
                            </template>
                            ...
                            <div class="doa-header">
                                ...
                                <div class="doa-header-inner">
                                    <div class="doa-header-title-row">
                                        ...
                                        <div>
                                            <h3 class="doa-header-title-text">Koleksi Doa & Mantra Hindu</h3>
                                            <p class="doa-header-sub">
                                                <span x-text="filteredDuas.length"></span> doa & mantra Hindu
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="doa-search-bar">
                                <div class="doa-search-input-wrap">
                                    ...
                                    <input type="text"
                                           ...
                                           placeholder="Cari doa... (contoh: gayatri, meditasi, keluarga)"
                    ...
                    {{-- SLOKA BHAGAVAD GITA / MOTIVASI --}}
                    <div class="verse-card">
                        <div class="verse-card-bg"></div>
                        <div class="verse-card-content">
                            <div class="verse-badge">
                                {{-- Om symbol icon --}}
                                <svg fill="none" viewBox="0 0 24 24" stroke-width="0" style="width:1.25rem;height:1.25rem;">
                                    <text x="12" y="18" text-anchor="middle" fill="currentColor" font-size="18" font-family="serif" font-weight="bold">à¥</text>
                                </svg>
                                <span>Sloka Bhagavad Gita Hari Ini</span>
                            </div>
...
@push('scripts')
    <script src="{{ asset('themes/ramadhan/js/nonmuslim/hindu/dashboard.js') }}?v={{ filemtime(public_path('themes/ramadhan/js/nonmuslim/hindu/dashboard.js')) }}" defer></script>
@endpush
