<x-filament-panels::page>
    ...
    <div x-data="hinduDashboard()" x-init="init()" class="ramadhan-app" data-formulir-url="{{ \App\Filament\Siswa\Pages\NonMuslim\Hindu\FormulirHarian::getUrl() }}">
        ...
        <div class="hero-header">
            ...
            <div class="absolute inset-0 overflow-hidden pointer-events-none" style="border-radius: 0 0 2rem 2rem;">
                ...
                <div class="islamic-deco islamic-deco-moon" style="top:6%; right:4%;">
                    <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <text x="32" y="42" text-anchor="middle" fill="white" opacity="0.18" font-size="36" font-family="serif" font-weight="bold">ॐ</text>
                        {{-- Light rays --}}
                ...
                {{-- ★ Pura (Balinese temple) silhouette bottom-left --}}
                ...
                {{-- ★ Small Hindu temple silhouette bottom-right --}}
                <div class="islamic-deco islamic-deco-mosque2" style="bottom:0; right:0;">
                    <svg width="180" height="110" viewBox="0 0 220 130" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {{-- Om symbol on temple --}}
                        <text x="110" y="78" text-anchor="middle" fill="white" opacity="0.08" font-size="14" font-family="serif">ॐ</text>
                        {{-- Tropical trees --}}
                ...
                {{-- ★ Mandala / geometric pattern top-left --}}
                ...
                {{-- ★ Diya / oil lamp (instead of bible) floating right-center --}}
            ...
            {{-- ★ Trishula (trident) floating (instead of music notes) --}}
            ...
            <div style="position:absolute; top:45%; right:16%; animation: float-slow 5.5s ease-in-out infinite; animation-delay: 0.8s; z-index:0;">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    <text x="12" y="18" text-anchor="middle" fill="white" opacity="0.12" font-size="20" font-family="serif">ॐ</text>
                </svg>
            </div>

            {{-- ★ Lotus small (peace / purity) --}}
                        ...
                        <div class="verse-card-content">
                            <div class="verse-badge">
                                ...
                                <svg fill="none" viewBox="0 0 24 24" stroke-width="0" style="width:1.25rem;height:1.25rem;">
                                    <text x="12" y="18" text-anchor="middle" fill="currentColor" font-size="18" font-family="serif" font-weight="bold">ॐ</text>
                                </svg>
