            ...
            <div class="ramadhan-content">
                ...
                <div class="center-menu-wrap">
                    <div class="center-menu">
                        ...
                        <a href="{{ \App\Filament\Siswa\Pages\NonMuslim\Hindu\FormulirHarian::getUrl() }}" class="center-menu-btn" style="text-decoration:none;" target="_blank" rel="noopener noreferrer">
                            <div class="center-menu-icon">
                        ...
                        <div class="card">
                            ...
                            <template x-if="calendarDays.filter(d => d.isPastUnfilled).length > 0">
                                <div class="cal-alert">
                                    ...
                                    <a href="{{ \App\Filament\Siswa\Pages\NonMuslim\Hindu\FormulirHarian::getUrl() }}" class="cal-alert-btn" style="text-decoration:none;" target="_blank">
                                        Isi Sekarang
                                    </a>
                                </div>
                            </template>
