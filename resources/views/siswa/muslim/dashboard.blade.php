            ...
            <div class="ramadhan-content">
                ...
                <div class="center-menu-wrap">
                    <div class="center-menu">
                        {{-- Left tabs: Kalender, Shalat, Jadwal --}}
                        ...
                        <a href="{{ \App\Filament\Siswa\Pages\Muslim\FormulirHarian::getUrl() }}" class="center-menu-btn" style="text-decoration:none;">
                            <div class="center-menu-icon">
