...
<?php $component->withAttributes([]); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('themes/ramadhan/css/al-quran.css')); ?>">

    <div x-data="alQuranPage()" x-init="init()" class="quran-page">

        
        <div class="quran-topbar">
            <a href="<?php echo e(\App\Filament\Siswa\Pages\Muslim\Dashboard::getUrl()); ?>" class="quran-back-btn">
    ...
    <script src="<?php echo e(asset('themes/ramadhan/js/al-quran.js')); ?>"></script>
...
<?php endif; ?>
<?php /**PATH C:\Project\buku-ramadhan-2025\resources\views/siswa/muslim/al-quran.blade.php ENDPATH**/ ?>