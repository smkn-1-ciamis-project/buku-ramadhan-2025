...
>
    ...
    <div class="pcm-modal" x-data="{
        ...
        nisn: '<?php echo e(auth()->user()?->nisn ?? ''); ?>',
...
$message = $__bag->first($__errorArgs[0]); ?> <div class="pcm-error"><?php echo e($message); ?></div> <?php unset($message);
...
<?php /**PATH C:\Project\buku-ramadhan-2025\resources\views/components/password-change-modal.blade.php ENDPATH**/ ?>