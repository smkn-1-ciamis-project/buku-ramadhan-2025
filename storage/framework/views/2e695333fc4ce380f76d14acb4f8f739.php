<div class="login-page" x-data="{ showDevicePopup: $wire.entangle('showDevicePopup'), showErrorPopup: $wire.entangle('showErrorPopup'), showLockPopup: $wire.entangle('showLockPopup'), lockSeconds: $wire.entangle('lockSeconds'), lockTimer: null }"
  ...
  <?php if (! $__env->hasRenderedOnce('0e7caa7a-5c60-4f0a-854e-54995d5f4631')): $__env->markAsRenderedOnce('0e7caa7a-5c60-4f0a-854e-54995d5f4631'); ?>
...
<?php endif; ?>
      ...
      <div class="portal-switch-wrap">
        <div class="portal-switch-divider-row">
          <div class="portal-switch-divider"></div>
          <span class="portal-switch-label">Bukan siswa?</span>
          <div class="portal-switch-divider"></div>
        </div>
        <div class="portal-switch-links">
          <a href="<?php echo e(url('/portal-guru-smkn1/login')); ?>" class="portal-switch-link">Login Guru</a>
          <a href="<?php echo e(url('/portal-kesiswaan-smkn1/login')); ?>" class="portal-switch-link">Login Kesiswaan</a>
        </div>
      </div>
    ...
    <div class="login-illust-col">
      ...
      <div class="illust-main">
        ...
        <div style="margin-top: 0.8rem; display: flex; justify-content: center;">
          <a href="<?php echo e(route('buku-panduan', ['role' => 'siswa'])); ?>" target="_blank" rel="noopener noreferrer"
  ...
  <?php echo $__env->make('components.login-slide-transition', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

</div>
<?php /**PATH C:\Project\buku-ramadhan-2025\resources\views/filament/siswa/pages/auth/login.blade.php ENDPATH**/ ?>