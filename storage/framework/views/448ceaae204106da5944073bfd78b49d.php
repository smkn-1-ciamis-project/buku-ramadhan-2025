...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('img/logo_smk.png')); ?>" type="image/png">
...
<body>
    <div class="err-card">
        ...
        <div class="err-hero">
            ...
            <div class="err-hero-title">Halaman Tidak Ditemukan</div>
            <div class="err-hero-sub">Halaman yang Anda cari tidak tersedia</div>
        </div>
        ...
        <div class="err-body">
            ...
            <p class="err-message">
                Halaman ini mungkin telah dipindahkan, dihapus, atau URL yang dimasukkan salah. Silakan periksa kembali alamat yang Anda tuju.
            </p>
        ...
        <div class="err-footer">
            <p class="err-footer-text">
                &copy; <?php echo e(date('Y')); ?> <a href="<?php echo e(url('/tim-pengembang')); ?>">Calakan</a> — SMKN 1 Ciamis
            </p>
        </div>
...
<?php /**PATH C:\Project\buku-ramadhan-2025\resources\views/errors/404.blade.php ENDPATH**/ ?>