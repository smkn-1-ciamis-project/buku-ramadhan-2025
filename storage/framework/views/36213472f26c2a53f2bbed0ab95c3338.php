    ...
    <div class="sa-wrap">
        ...
        <div class="sa-hero">
            ...
            <div class="sa-hero-content">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isRamadhan): ?>
                    <div class="sa-ramadhan-card">
                        <span class="sa-moon">🌙</span>
                        <div>
                            <p class="sa-ramadhan-label">Ramadhan</p>
                            <p class="sa-ramadhan-day">Hari ke-<?php echo e($hariKe); ?></p>
        ...
        <div class="sa-stats">
            <div class="sa-stat sa-bg-blue">
                ...
                <div>
                    ...
                    <p class="sa-stat-value"><?php echo e($totalGuru); ?></p>
                </div>
            </div>
            <div class="sa-stat sa-bg-blue">
                <div class="sa-stat-icon">
                ...
                <div>
                    ...
                    <p class="sa-stat-value"><?php echo e($totalSiswa); ?></p>
                </div>
            </div>
            <div class="sa-stat sa-bg-blue">
                <div class="sa-stat-icon">
                ...
                <div>
                    ...
                    <p class="sa-stat-value"><?php echo e($totalKelas); ?></p>
                </div>
            </div>
            <div class="sa-stat sa-bg-blue">
                <div class="sa-stat-icon">
                ...
                <div>
                    ...
                    <p class="sa-stat-value"><?php echo e($totalFormulir); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="sa-mid">
                ...
                <div class="sa-card-body">
                    <div class="sa-today-grid">
                        <div class="sa-today-item sa-today-item-blue">
                            <p class="sa-today-num" style="color:#2563eb;"><?php echo e($formulirHariIni); ?></p>
                            <p class="sa-today-label sa-text-muted">Formulir Masuk</p>
                        </div>
                        <div class="sa-today-item sa-today-item-blue">
                            <p class="sa-today-num" style="color:#2563eb;"><?php echo e($siswaSubmitHariIni); ?></p>
                        ...
                        <div class="sa-compliance-ring">
                            <svg viewBox="0 0 36 36">
                                ...
                                <circle cx="18" cy="18" r="14" fill="none" stroke-width="3.5"
                                    stroke="<?php echo e($complianceRate >= 70 ? '#10b981' : ($complianceRate >= 40 ? '#f59e0b' : '#ef4444')); ?>"
                                    stroke-dasharray="<?php echo e($complianceRate * 0.88); ?> 88"
                                    stroke-linecap="round"/>
                            </svg>
                            <span class="sa-compliance-pct"><?php echo e($complianceRate); ?>%</span>
                        </div>
                        <div class="sa-compliance-info">
                            <p class="sa-compliance-title">Tingkat Kepatuhan</p>
                            <p class="sa-compliance-desc sa-text-muted"><?php echo e($siswaSubmitHariIni); ?> dari <?php echo e($totalSiswa); ?> siswa</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="sa-card">
                <div class="sa-card-head">
                    ...
                    <span style="font-size:.675rem; font-weight:600; color:#9ca3af;"><?php echo e($totalFormulir); ?></span>
                </div>
                <div class="sa-card-body">
                    <div class="sa-form-item">
                        <span class="sa-form-dot" style="background:#f59e0b;"></span>
                        <span class="sa-form-label">Menunggu</span>
                        <span class="sa-form-count" style="color:#d97706;"><?php echo e($totalPending); ?></span>
                    </div>
                    <div class="sa-form-item">
                        <span class="sa-form-dot" style="background:#10b981;"></span>
                        <span class="sa-form-label">Diverifikasi</span>
                        <span class="sa-form-count" style="color:#059669;"><?php echo e($totalVerified); ?></span>
                    </div>
                    <div class="sa-form-item">
                        <span class="sa-form-dot" style="background:#ef4444;"></span>
                        <span class="sa-form-label">Ditolak</span>
                        <span class="sa-form-count" style="color:#dc2626;"><?php echo e($totalRejected); ?></span>
                    </div>
                    <div class="sa-form-item">
                        <span class="sa-form-dot" style="background:#8b5cf6;"></span>
                        <span class="sa-form-label">Divalidasi Kesiswaan</span>
                        <span class="sa-form-count" style="color:#7c3aed;"><?php echo e($totalValidated); ?></span>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalFormulir > 0): ?>
                        <div class="sa-form-bar-wrap" style="margin-top:1rem;">
                            <div style="display:flex; height:.375rem; border-radius:.25rem; overflow:hidden;">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalVerified > 0): ?>
                                    <div style="width:<?php echo e(($totalVerified / $totalFormulir) * 100); ?>%; background:#10b981;"></div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalPending > 0): ?>
                                    <div style="width:<?php echo e(($totalPending / $totalFormulir) * 100); ?>%; background:#f59e0b;"></div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalRejected > 0): ?>
                                    <div style="width:<?php echo e(($totalRejected / $totalFormulir) * 100); ?>%; background:#ef4444;"></div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="sa-compliance">
                        <div class="sa-compliance-ring">
                            <svg viewBox="0 0 36 36">
                                <circle class="sa-ring-bg" cx="18" cy="18" r="14" fill="none" stroke-width="3.5"/>
                                <circle cx="18" cy="18" r="14" fill="none" stroke-width="3.5"
                                    stroke="<?php echo e($validasiRate >= 70 ? '#10b981' : ($validasiRate >= 40 ? '#f59e0b' : '#ef4444')); ?>"
                                    stroke-dasharray="<?php echo e($validasiRate * 0.88); ?> 88"
                                    stroke-linecap="round"/>
                            </svg>
                            <span class="sa-compliance-pct"><?php echo e($validasiRate); ?>%</span>
                        </div>
                        <div class="sa-compliance-info">
                            <p class="sa-compliance-title">Tingkat Validasi</p>
                            <p class="sa-compliance-desc sa-text-muted"><?php echo e($totalValidated); ?> dari <?php echo e($totalFormulir); ?> formulir</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="sa-compliance">
                        <div class="sa-compliance-ring">
                            <svg viewBox="0 0 36 36">
                                <circle class="sa-ring-bg" cx="18" cy="18" r="14" fill="none" stroke-width="3.5"/>
                                <circle cx="18" cy="18" r="14" fill="none" stroke-width="3.5"
                                    stroke="<?php echo e($verifyRate >= 70 ? '#10b981' : ($verifyRate >= 40 ? '#f59e0b' : '#ef4444')); ?>"
                                    stroke-dasharray="<?php echo e($verifyRate * 0.88); ?> 88"
                                    stroke-linecap="round"/>
                            </svg>
                            <span class="sa-compliance-pct"><?php echo e($verifyRate); ?>%</span>
                        </div>
                        <div class="sa-compliance-info">
                            <p class="sa-compliance-title">Tingkat Verifikasi</p>
                            <p class="sa-compliance-desc sa-text-muted"><?php echo e($totalVerified); ?> dari <?php echo e($totalFormulir); ?> formulir</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="sa-bottom">
            ...
            <div class="sa-card">
                <div class="sa-card-head">
                    ...
                    <a href="<?php echo e(url('/portal-admin-smkn1/log-formulir')); ?>" class="sa-link">Lihat Semua →</a>
                </div>
                <div style="overflow-x:auto;">
                    <table class="sa-table">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentSubmissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td style="font-weight:500;"><?php echo e($sub['user_name']); ?></td>
                                    <td class="sa-text-muted"><?php echo e($sub['user_kelas']); ?></td>
                                    <td style="text-align:center;"><span class="sa-badge-hari"><?php echo e($sub['hari_ke']); ?></span></td>
                                    <td style="text-align:center;">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sub['status'] === 'pending'): ?>
                                    ...
                                    <td style="text-align:right;" class="sa-text-muted" title="<?php echo e($sub['created_at_full']); ?>"><?php echo e($sub['created_at']); ?></td>
                                </tr>
            ...
            <div class="sa-card">
                <div class="sa-card-head">
                    ...
                    <a href="<?php echo e(url('/portal-admin-smkn1/kelas')); ?>" class="sa-link">Kelola →</a>
                </div>
                <div class="sa-card-body" style="padding:.875rem 1.25rem; overflow-y:auto; max-height:600px;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $kelasOverview; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="sa-kelas-item">
                            <div class="sa-kelas-info">
                                <p class="sa-kelas-name"><?php echo e($k['nama']); ?></p>
                                <p class="sa-kelas-wali sa-text-muted"><?php echo e($k['wali']); ?></p>
                            </div>
                            <div class="sa-kelas-counts">
                                <p class="sa-kelas-siswa"><?php echo e($k['siswa_count']); ?><span style="font-size:.7rem; font-weight:400;"> siswa</span></p>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isRamadhan): ?>
                                    <p class="sa-kelas-rate" style="color:<?php echo e($k['rate'] >= 70 ? '#059669' : ($k['rate'] >= 40 ? '#d97706' : '#dc2626')); ?>;">
                                        <?php echo e($k['rate']); ?>% hari ini
                                    </p>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isRamadhan): ?>
                            <div class="sa-kelas-bar">
                                <div class="sa-kelas-bar-fill" style="width:<?php echo e($k['rate']); ?>%; background:<?php echo e($k['rate'] >= 70 ? '#10b981' : ($k['rate'] >= 40 ? '#f59e0b' : '#ef4444')); ?>;"></div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="sa-empty">
...
<?php endif; ?>
<?php /**PATH C:\Project\buku-ramadhan-2025\resources\views/filament/superadmin/pages/dashboard.blade.php ENDPATH**/ ?>