...
<?php $component->withAttributes([]); ?>
    <script>window.__siswaUserId = '<?php echo e(auth()->id()); ?>'; window.__appSettings = <?php echo json_encode(\App\Models\AppSetting::getForFrontend(), 15, 512) ?>;</script>
    ...
    <div x-data="ramadhanDashboard()" x-init="init()" class="ramadhan-app" data-formulir-url="<?php echo e(\App\Filament\Siswa\Pages\Muslim\FormulirHarian::getUrl()); ?>">
            ...
            <div class="hero-inner">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <img src="<?php echo e(asset('img/logo_smk.png')); ?>" alt="SMKN 1 Ciamis" class="w-10 h-10 lg:w-12 lg:h-12">
                        <div>
            ...
            <div class="ramadhan-content">
                ...
                <div class="center-menu-wrap">
                    <div class="center-menu">
                        ...
                        <template x-for="tab in sidebarTabs.slice(0, 3)" :key="tab.id">
                            <button @click="activeTab = tab.id" class="center-menu-btn" :class="activeTab === tab.id && 'active'">
                                <div class="center-menu-icon">
                                    ...
                                    <svg x-show="tab.id === 'shalat'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.745 3.745 0 011.043 3.296A3.745 3.745 0 0121 12z"/></svg>
                        ...
                        <a href="<?php echo e(\App\Filament\Siswa\Pages\Muslim\FormulirHarian::getUrl()); ?>" class="center-menu-btn" style="text-decoration:none;">
                            <div class="center-menu-icon">
                        ...
                        <a href="<?php echo e(\App\Filament\Siswa\Pages\Muslim\AlQuran::getUrl()); ?>" class="center-menu-btn" style="text-decoration:none;">
                            <div class="center-menu-icon">
                ...
                <div class="content-area">
                        ...
                        <div class="card">
                            ...
                            <template x-if="calendarDays.filter(d => d.isPastUnfilled).length > 0">
                                <div class="cal-alert">
                                    ...
                                    <a href="<?php echo e(\App\Filament\Siswa\Pages\Muslim\FormulirHarian::getUrl()); ?>" class="cal-alert-btn" style="text-decoration:none;">
                                        Isi Sekarang
                                    </a>
                                </div>
                            </template>
                    ...
                    <div x-show="activeTab === 'shalat'" x-transition.opacity.duration.200ms>
                        <div class="checkin-card">
                            ...
                            <div class="checkin-body">
                                ...
                                <div class="checkin-section">
                                    <div class="checkin-section-title">
                                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2" style="width:16px;height:16px;color:#7c3aed;"><path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.455 2.456L21.75 6l-1.036.259a3.375 3.375 0 00-2.455 2.456zM16.894 20.567L16.5 21.75l-.394-1.183a2.25 2.25 0 00-1.423-1.423L13.5 18.75l1.183-.394a2.25 2.25 0 001.423-1.423l.394-1.183.394 1.183a2.25 2.25 0 001.423 1.423l1.183.394-1.183.394a2.25 2.25 0 00-1.423 1.423z"/></svg>
                                        <span>Shalat Sunnah</span>
                                    </div>
                                    <div class="checkin-grid">
                                        <template x-for="prayer in checkinSunnah" :key="prayer.id">
                                            <button class="checkin-item" :class="getCheckinClass(prayer.id)" @click="openCheckinModal(prayer)">
                                                <div class="checkin-item-icon" :class="getCheckinIconClass(prayer.id)">
                                                    ...
                                                    <svg x-show="getCheckinStatus(prayer.id) === 'ya'" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>
                                ...
                                <div class="checkin-legend">
                                    <div class="checkin-legend-item">
                                        <span class="checkin-legend-dot" style="background:#16a34a"></span>
                                        <span>Jamaah / Ya</span>
                                    </div>
                                    <div class="checkin-legend-item">
                                        <span class="checkin-legend-dot" style="background:#eab308"></span>
                                        <span>Munfarid</span>
                                    </div>
                                    <div class="checkin-legend-item">
                                        <span class="checkin-legend-dot" style="background:#dc2626"></span>
                                        <span>Tidak</span>
                                    </div>
                                </div>
                                </div>
                    ...
                    <div x-show="showCheckinModal" x-transition.opacity class="checkin-modal-overlay" @click.self="showCheckinModal = false" style="display:none;">
                        <div class="checkin-modal" x-show="showCheckinModal" x-transition.scale.90>
                            <div class="checkin-modal-header">
                                <h3 class="checkin-modal-title" x-text="'Check-in ' + (checkinModalPrayer?.name || '')"></h3>
                                <button @click="showCheckinModal = false" class="checkin-modal-close">
                            ...
                            <template x-if="checkinModalPrayer?.tipe === 'wajib'">
                                <div class="checkin-modal-options">
                                    <button class="checkin-opt checkin-opt-jamaah" @click="submitCheckin('jamaah')" :disabled="checkinSaving">
                                        <div class="checkin-opt-icon">
                                        ...
                                        <span class="checkin-opt-label">Jamaah</span>
                                        <span class="checkin-opt-desc">Shalat berjamaah</span>
                                    </button>
                                    <button class="checkin-opt checkin-opt-munfarid" @click="submitCheckin('munfarid')" :disabled="checkinSaving">
                                        <div class="checkin-opt-icon">
                                        ...
                                        <span class="checkin-opt-label">Munfarid</span>
                                        <span class="checkin-opt-desc">Shalat sendiri</span>
                                    </button>
                                    <button class="checkin-opt checkin-opt-tidak" @click="submitCheckin('tidak')" :disabled="checkinSaving">
                                        <div class="checkin-opt-icon">
                                        ...
                                        <span class="checkin-opt-label">Tidak Shalat</span>
                                        <span class="checkin-opt-desc">Tidak melaksanakan</span>
                                    </button>
                                </div>
                            </template>

                            
                            <template x-if="checkinModalPrayer?.tipe === 'sunnah'">
                                <div class="checkin-modal-options checkin-modal-options-sunnah">
                                    <button class="checkin-opt checkin-opt-ya" @click="submitCheckin('ya')" :disabled="checkinSaving">
                                        <div class="checkin-opt-icon">
                                        ...
                                        <span class="checkin-opt-label">Ya</span>
                                        <span class="checkin-opt-desc">Melaksanakan shalat sunnah</span>
                                    </button>
                                    <button class="checkin-opt checkin-opt-tidak" @click="submitCheckin('tidak')" :disabled="checkinSaving">
                                        <div class="checkin-opt-icon">
                                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"/></svg>
                                        </div>
                                        <span class="checkin-opt-label">Tidak</span>
                                        <span class="checkin-opt-desc">Tidak melaksanakan</span>
                                    </button>
                                </div>
                            </template>
                            ...
                            <div x-show="checkinSaving" class="checkin-modal-loading">
                                <div class="checkin-spinner"></div>
                                <span>Menyimpan...</span>
                            </div>
                        </div>
                                    ...
                                    <div class="qibla-compass-dial" :style="'transform: rotate(' + compassRotation + 'deg)'">
                                        <div class="qibla-compass-face">
                                            <svg viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 0; $i < 360; $i += 5): ?>
                                                    <?php
                                                        $rad = deg2rad($i);
                                                        $sinI = sin($rad);
                                                        $cosI = cos($rad);
                                                    ...
                                                    ?>
                                                    <line x1="<?php echo e(150 + $outerR * $sinI); ?>" y1="<?php echo e(150 - $outerR * $cosI); ?>"
                                                          x2="<?php echo e(150 + $innerR * $sinI); ?>" y2="<?php echo e(150 - $innerR * $cosI); ?>"
                                                          stroke="<?php echo e($color); ?>" stroke-width="<?php echo e($strokeW); ?>" stroke-linecap="round"/>
                                                <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [30,60,90,120,150,180,210,240,270,300,330]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                        $rad = deg2rad($deg);
                                                        $tx = 150 + 113 * sin($rad);
                                                        $ty = 150 - 113 * cos($rad) + 4;
                                                    ?>
                                                    <text x="<?php echo e($tx); ?>" y="<?php echo e($ty); ?>" text-anchor="middle" fill="#94a3b8" font-size="10" font-weight="600" font-family="system-ui, sans-serif"><?php echo e($deg); ?></text>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [45, 135, 225, 315]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php $r = deg2rad($deg); ?>
                                                    <line x1="<?php echo e(150 + 60 * sin($r)); ?>" y1="<?php echo e(150 - 60 * cos($r)); ?>"
                                                          x2="<?php echo e(150 + 96 * sin($r)); ?>" y2="<?php echo e(150 - 96 * cos($r)); ?>"
                                                ...
                                                <text x="<?php echo e(150 + 100 * sin(deg2rad(45))); ?>" y="<?php echo e(150 - 100 * cos(deg2rad(45)) + 3); ?>" text-anchor="middle" fill="#cbd5e1" font-size="9" font-weight="600" font-family="system-ui, sans-serif">TL</text>
                                                <text x="<?php echo e(150 + 100 * sin(deg2rad(135))); ?>" y="<?php echo e(150 - 100 * cos(deg2rad(135)) + 3); ?>" text-anchor="middle" fill="#cbd5e1" font-size="9" font-weight="600" font-family="system-ui, sans-serif">TG</text>
                                                <text x="<?php echo e(150 + 100 * sin(deg2rad(225))); ?>" y="<?php echo e(150 - 100 * cos(deg2rad(225)) + 3); ?>" text-anchor="middle" fill="#cbd5e1" font-size="9" font-weight="600" font-family="system-ui, sans-serif">BD</text>
                                                <text x="<?php echo e(150 + 100 * sin(deg2rad(315))); ?>" y="<?php echo e(150 - 100 * cos(deg2rad(315)) + 3); ?>" text-anchor="middle" fill="#cbd5e1" font-size="9" font-weight="600" font-family="system-ui, sans-serif">BL</text>
                                            </svg>
                                        </div>
                                    </div>
                    ...
                    <div x-show="activeTab === 'account'" x-transition.opacity.duration.200ms>
                        ...
                        <div class="akun-card">
                            <div class="akun-header">
                                ...
                                <div class="akun-header-inner">
                                    <div class="akun-avatar">
                                        <span><?php echo e(strtoupper(substr(auth()->user()->name ?? 'S', 0, 1))); ?></span>
                                    </div>
                                    <div class="akun-header-info">
                                        <h3 class="akun-name"><?php echo e(auth()->user()->name ?? 'Siswa'); ?></h3>
                                        <p class="akun-email"><?php echo e(auth()->user()->email ?? '-'); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="akun-biodata">
                                ...
                                <div class="akun-bio-grid">
                                    <div class="akun-bio-item">
                                        ...
                                        <span class="akun-bio-value"><?php echo e(auth()->user()->name ?? '-'); ?></span>
                                    </div>
                                    <div class="akun-bio-item">
                                        <span class="akun-bio-label">NISN</span>
                                        <span class="akun-bio-value"><?php echo e(auth()->user()->nisn ?? '-'); ?></span>
                                    </div>
                                    <div class="akun-bio-item">
                                        <span class="akun-bio-label">Email</span>
                                        <span class="akun-bio-value"><?php echo e(auth()->user()->email ?? '-'); ?></span>
                                    </div>
                                    <div class="akun-bio-item">
                                        <span class="akun-bio-label">Agama</span>
                                        <span class="akun-bio-value">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->agama): ?>
                                                <span class="akun-agama-badge <?php echo e(strtolower(auth()->user()->agama) === 'islam' ? 'akun-agama-islam' : 'akun-agama-other'); ?>">
                                                    <?php echo e(auth()->user()->agama); ?>
                            ...
                            ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($waliKelas): ?>
                            <div class="akun-biodata akun-wali-section">
                                ...
                                <div class="akun-wali-card">
                                    <div class="akun-wali-avatar">
                                        <span><?php echo e(strtoupper(substr($waliKelas->name ?? 'G', 0, 1))); ?></span>
                                    </div>
                                    <div class="akun-wali-info">
                                        <div class="akun-wali-name"><?php echo e($waliKelas->name); ?></div>
                                        <div class="akun-wali-kelas">Wali Kelas <?php echo e(auth()->user()->kelas->nama ?? ''); ?></div>
                                    </div>
                                </div>

                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($waliKelas->no_hp): ?>
                                <a href="https://wa.me/<?php echo e(preg_replace('/^0/', '62', preg_replace('/[^0-9]/', '', $waliKelas->no_hp))); ?>" target="_blank" class="akun-wali-wa-btn">
                                    ...
                                    <span class="akun-wali-wa-num"><?php echo e($waliKelas->no_hp); ?></span>
                                </a>
                                <?php else: ?>
                                ...
                                <div x-show="showLogoutConfirm" x-transition.opacity class="logout-overlay" @click.self="showLogoutConfirm = false" style="display:none;">
                                    <div class="logout-modal" x-show="showLogoutConfirm" x-transition.scale.90>
                                        ...
                                        <div class="logout-modal-actions">
                                            ...
                                            <form method="POST" action="<?php echo e(route('filament.siswa.auth.logout')); ?>" style="display:inline;">
                                                <?php echo csrf_field(); ?>
                                        ...
                                        <div style="text-align:left;width:100%;">
                                            ...
                                            <div style="margin-bottom:14px;">
                                                ...
                                                <ul style="margin:0;padding-left:16px;font-size:0.78rem;color:#4b5563;line-height:1.9;">
                                                    ...
                                                    <li>Pencarian surah &amp; pencarian ayat di dalam surah</li>
                                                    <li>Menu Jadwal Sholat &amp; Arah Kiblat digabung jadi satu</li>
                                                    <li>Aplikasi lebih cepat &amp; responsif dari sebelumnya</li>
                                                    <li>Versi aplikasi bisa diklik untuk melihat riwayat pembaruan</li>
                                                </ul>
                                            </div>
                                            <div style="margin-bottom:14px;">
                                                <div style="display:flex;align-items:center;gap:8px;margin-bottom:5px;">
        ...
        <div class="watermark-footer">
            <a href="<?php echo e(route('tim-pengembang')); ?>" target="_blank" rel="noopener noreferrer">
                &copy; <?php echo e(date('Y')); ?> SMKN 1 Ciamis
            </a>
        </div>
    ...
    <?php echo $__env->make('components.password-change-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('themes/ramadhan/css/dashboard.css')); ?>?v=<?php echo e(filemtime(public_path('themes/ramadhan/css/dashboard.css'))); ?>">
<?php $__env->stopPush(); ?>

<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('themes/ramadhan/js/muslim/dashboard.js')); ?>?v=<?php echo e(filemtime(public_path('themes/ramadhan/js/muslim/dashboard.js'))); ?>" defer></script>
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Project\buku-ramadhan-2025\resources\views/siswa/muslim/dashboard.blade.php ENDPATH**/ ?>